<div id="mainimg">
    <div id="header" style="margin-top:10px;">
        <h1>Piano Lessons For Adults</h1>

        <div class="bodytext">
            <p>Anastasiya teaches adults of all levels - from the beginner to the professional.</p>
            <img width="340" height="255" align="right" alt="" src="/images/piano_lessons_for_adults_with_anastasiya.jpg" alt="Piano Lessons For Adults" title="Piano Lessons For Adults" style="margin-left: 11px; border:2px solid #FFF"/>
            <h2>Adult Absolute Beginner</h2>
            <p>Perhaps you have no previous experience but would love to take piano lessons.
                <br/>Don't be afraid, it's never too late!
                <br/>Anastasiya is here to guide you on your first steps.</p>
            ...
            <ul class="adultslist">
                <li>It can help you to rekindle your love for music</li>
                <li>It's a wonderful way to unwind</li>
                <li>It helps to cultivate your personal growth</li>
                <li>It gives you the chance to explore the world of music</li>
                <li>It opens up for you the unlimited opportunity for musical expression</li>
                <li>It's a chance to escape the office for an hour</li>
                <li>It enhances and develops better concentration</li>
                <li>It gives you a chance to fulfil your artistic desires, whether it's playing the piano for friends, or playing with other musicians, or composing your own music</li>
            </ul>
        </div>
    </div>
</div>
