<div id="mainimg">
    <img src="/images/new/piano-lessons-in-dublin-home.jpg" width="720" height="480" alt="Piano Lessons In Dublin" title="Piano Lessons In Dublin"/>
        ...
        <div align="justify">
            <div class="bodytext">
                <p style="text-align: center;font-style: italic;font-weight: bold;">
                    *Have you always dreamed of playing piano, but put it off?<br/><br/>
                        *Have you played before and always wanted to go back?<br/><br/>
                ...
                <div class="h1" style="width:539px;margin:0px auto; color: #4B0082; font-size: 25px; line-height: 26px; text-align: center;">
                    <h1 style="margin-bottom:0px;">
                        Piano lessons in Dublin City with professional pianist and piano teacher,
                    </h1>
                    Graduate of Prague Academy of Music,<br/>
                    Anastasiya Stukalova.
                </div>
                <p style="text-align:center;">All ages and levels catered for- from beginners to professionals.<br/>
                    All lessons are held on a one-to-one basis.
                </p>
                <h2 class="mainH2">*Perhaps you've had piano lessons in the past, either as a child</h2>
                <p style="text-align:center; font-style: italic; font-weight: bold; width:513px; margin:0 auto;">or as a young adult, but because of circumstances had to give it up.<br/><br/>
                    *Maybe you are a complete beginner and you want to embark<br/> on a new musical adventure.<br/><br/>
                    *Perhaps you are currently a student, but you feel that<br/> you are facing a lack of motivation and inspiration.<br/><br/>
                    *Then why not call Anastasiya today to discuss how to rekindle your desire and finally fulfill your goals in music.
                </p>
